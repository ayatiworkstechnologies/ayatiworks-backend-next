    ...
    return (
        <div className="space-y-6 animate-fade-in-up">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    <Link href="/settings/departments" className="inline-flex items-center gap-1 text-gray-500 hover:text-gray-700 mb-2">
                ...
                <div className="flex gap-2">
                    <Link href={`/settings/departments/${params.id}/edit`}>
