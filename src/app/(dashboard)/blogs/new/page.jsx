  ...
  return (
    <div className="space-y-6 animate-fade-in-up">
      ...
      <div className="page-header flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <Link href="/blogs" className="flex items-center gap-2 text-muted-foreground hover:text-foreground transition-colors mb-2">
        ...
        <div className="flex gap-2">
          <Button variant="secondary" onClick={() => setFormData(prev => ({ ...prev, status: 'draft' }))}>
            Save Draft
          </Button>
